...
export class CalendarService {
    ...
    private readonly collection = getFirebaseAdmin().firestore().collection('outfits_calendar');

    private docToOOTD(id: string, data: FirebaseFirestore.DocumentData | undefined): OOTD | null {
        if (!data) return null;
        return {
            id,
